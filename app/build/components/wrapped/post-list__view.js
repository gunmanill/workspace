require.define("post-list:view", function(require, module, exports) {module.template = function anonymous(it) {
var out='<!--  --><div class="b-post-list__content"></div>';return out;
